...
function Cart() {
  ...
  // hook used to navigate to a particular paths or page
    ...
    <div style={{marginTop:'100px'}}>
          ...
          <div className='col-lg-4'>
            <div className='border shadow p-5'>
              ...
              <h5>Total Price: <span className='text-warning fw-bolder'></span>₹ {total}</h5>
              <button className='btn btn-success rounded w-100' onClick={handleCart}>CHEKOUT</button>
            </div>
          </div>
          </div>:
